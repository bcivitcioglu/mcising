...
class TestMetropolisSweep:
    ...
    def test_high_temp_high_acceptance(self) -> None:
        ...
        accepted, attempted = sim.metropolis_sweep(100, 0.001)  # beta ~ 0
    ...
    def test_ground_state_stability(self) -> None:
        ...
        e_before = sim.energy()
        sim.metropolis_sweep(100, 100.0)  # Very high beta ≈ T→0
        e_after = sim.energy()
    ...
    def test_deterministic_with_same_seed(self) -> None:
        ...
        sim1.metropolis_sweep(10, 0.5)
        sim2.metropolis_sweep(10, 0.5)
    ...
    def test_different_seeds_diverge(self) -> None:
        ...
        sim1.metropolis_sweep(50, 0.5)
        sim2.metropolis_sweep(50, 0.5)
